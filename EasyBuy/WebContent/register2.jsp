...
<div id="header" class="wrap">
	...
	<div class="help"><c:if test="${name!=null}"><a href="selectdd?dd=${name.EU_USER_ID }">个人订单</a></c:if>
	<c:if test="${name!=null}">当前用户${name.EU_USER_ID }</c:if>
	<a href="ShopSelect" class="shopping">购物车</a>
	<c:if test="${name==null}"><a href="login.jsp">登录</a>|<a href="register.jsp">注册</a></c:if>
	<c:if test="${name!=null}"><a href="zx">退出</a></c:if>
	<c:if test="${name!=null}"><a href="SelallServlet">留言</a></c:if>
...
<div id="register" class="wrap">
	<div class="shadow">
		...
		<div class="box">
			...
			<form id="regForm" method="post" action="register2" onsubmit="return checkForm(this);">
				<table>
					<tr>
					...
					<tr>
						<td></td>
						<td><label class="ui-green"><input type="submit" name="submit" disabled=true id="sub" value="成为店家" /></label></td>
					</tr>
				</table>
				<a href=""></a>
			</form>

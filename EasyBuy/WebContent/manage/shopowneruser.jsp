...
<div id="position" class="wrap">
	您现在的位置：<a href="index.jsp">Hello-商城</a> &gt; 管理后台
</div>
	...
	<div id="menu-mng" class="lefter">
		<div class="box">
			<dl>
				...
				<dt>审核店家</dt>
				<dd><a href="shopowneruser">审核开店申请</a></dd>
			</dl>
		</div>
	</div>
	<div class="main">
		...
		<div class="manage">
			<table class="list">
				...
				<tr>
				<c:if test="${u.EU_STATUS==3 and u.EU_IDENTITY_CODE==NULL}">
					...
					<td class="w1 c"><a href="shopowneruserupdate?id=${u.EU_USER_ID }">店铺审核通过</a></td>
					</c:if>
				</tr>
				</c:forEach>
			</table>

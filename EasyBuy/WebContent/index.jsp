...
<div id="header" class="wrap">
	...
	<c:if test="${name!=null}">当前用户${name.EU_USER_ID }</c:if><a href="ShopSelect" class="shopping">购物车</a>
	...
	<c:if test="${name.EU_STATUS==3}"><a href="shopowner/index.jsp" >去店铺</a></c:if></div>
	<div class="navbar">
		<ul class="clearfix">
			<c:choose>
